...
//!
//! This module determines what semantic element the cursor is positioned on
//! in a WiX XML file (element name, attribute name, or attribute value).
...
///
/// # Arguments
/// * `source` - The XML source text
/// * `line` - Line number (1-based)
/// * `column` - Column number (1-based)
///
/// # Returns
/// A [`HoverTarget`] indicating what's under the cursor, or `HoverTarget::None`.
